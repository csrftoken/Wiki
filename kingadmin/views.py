        ...
        if table_name in site.enabled_admins[app_name]:
            ...
            if admin_class.add_form == None:
                model_form = forms.create_form(admin_class.model,
                                               ...
                                               form_create=True,
                                               request=request)
            else:  # this management has customized  creation form defined
            ...
            if embed:
                ...
                return render(request, 'kingadmin/table_add.html', return_data)
...
def password_reset_form(request, app_name, table_db_name, user_id):
    ...
    if can_change_user_password:
        ...
        return HttpResponse("Only management user has permission to change password")