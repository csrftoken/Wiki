...
class BaseKingAdmin(object):
    ...
    object_add_link = None  # 新增对象连接
    back_link = None  # 页面回退
    instance = None  # self.instance 代指当前循环的obj
    ...
    def delete_selected_objs(self, request, queryset):
        ...
        return render(
            request,
            "kingadmin/table_objs_delete.html",
            {
                "objs": queryset,
                "admin_class": self,
                "app_name": app_name,
...
class AdminSite(object):
    ...
    def register(self, model_class, admin_class=None):
        ...
        if not admin_class:  # no custom management class , use BaseAdmin
